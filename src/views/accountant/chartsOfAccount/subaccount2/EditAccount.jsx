...
<SingleSelect  
    ...
    {
      subAccount=<SubAccount id={this.props.match.params.id} name={this.state.account_name} path="/accountant/ChartsOfAccount/EditCofA2"  mainAccount={this.state.account_name} type={this.state.account_type}></SubAccount>;
...
<div>
        ...
        <BreadCrumbs
                    ...
                    breadCrumbActive="Sub Account 2"
                />
...
<Link to={`/accountant/ChartsOfAccount/EditCofA/${this.state.parent_account_id}`}><Button  type='button' value="" color='warning mr-2'>Back</Button></Link>
