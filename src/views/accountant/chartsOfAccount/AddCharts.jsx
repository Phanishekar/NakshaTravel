...
export default class AddCharts extends Component {
  ...
  render() {
    ...
    {
      redire=<Redirect to="/accountant/redirect/1/list"></Redirect>
    }
...
<div>
  {redire}
       ...
       <ModalHeader size="lg" style={{height:'80px',alignItems:"center"}} toggle={this.toggle}><span style={{marginLeft:"20px"}}>Create Account</span></ModalHeader>
                <ModalBody>
               ...
               <br/>
                ...
                <Input name="parent_account_id" value="0"    hidden></Input>
<br/><hr/>
...
<Button  type='submit' value="submit" color='primary mr-2'>Submit</Button> </div>
        ...
        <React.Fragment>
        <div  >
        <Button  color='primary mr-2'  id='addbtn' className='ml-2'  onClick={this.toggle}>+ Add Account</Button>
