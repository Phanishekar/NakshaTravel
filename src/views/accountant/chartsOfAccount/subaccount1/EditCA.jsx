...
export default class AddCharts extends Component {
  ...
  render() {
    ...
    if(this.state.account_type=="Bank")
    {
       ...
       <Col lg="6">
           <Input name="account_number" type='text'  value={this.state.account_number}
...
<SingleSelect  
    ...
    let subAccount="";
    if(this.state.account_type=="Other Current Asset" ||this.state.account_type=="Cash" ||this.state.account_type=="Fixed Assets" ||
    this.state.account_type=="Other Current Liability" ||this.state.account_type=="Long Term Liability" ||this.state.account_type=="Equilty" ||
    this.state.account_type=="Income" ||this.state.account_type=="Expence" ||this.state.account_type=="Cost of Goods Sold"  )

    {
      subAccount=<SubAccount id={this.props.match.params.id} name={this.state.account_name} path="/accountant/ChartsOfAccount/EditCofA1" mainAccount={this.state.account_name} type={this.state.account_type}></SubAccount>;
...
<div>
        ...
        <BreadCrumbs
               ...
               <br/>
                ...
                {Account_currency}
               <br/>
               <Input name="parent_account_id" value={this.state.parent_account_id}    hidden></Input>
                <Row>
...
<Link to={`/accountant/ChartsOfAccount`}><Button  type='button' value="" color='warning mr-2'>Back</Button></Link>
