...
export default class EditFamily extends Component {
      ...
      for(var j=0;j<i;j++ )
      {
        ...
        .then((response) => {
          if (response.data.status == 200) {
            ...
            this.props.history.push(`/customer/induvidual/edit/${this.state.corporate_id}`);
          }
        })
        .catch((error) => {
  ...
  async    componentDidMount() {
    ...
    individual_family_residential_pincode:induidual.data.customer.individual_family_residential_country,
  ...
  render() {
    ...
    <SingleSelect  name="individual_family_blood_group" 
            ...
            <Row className='mt-1' >
              ...
              <Col>
                <Input name="individual_family_yellowfever_attachment"
                  type='file'
                  onChange={this.handleChanges} />  {this.state.erroryellowfever?<small style={{color:"red"}}>{this.state.erroryellowfever}</small>:
            ...
            <Row className='mt-1' >
              ...
              <Col>
                <Input name="individual_family_covid19_attachment"
                  type='file'
                  onChange={this.handleChanges} />  {this.state.errorcovid19? <small style={{color:"red"}}>{this.state.errorcovid19}</small> :
            ...
            <Row className='mt-1' >
              ...
              <Col>
                <Input type='file'
                  ...
                  onChange={this.handleChanges} />{this.state.errorothervacination?<small style={{color:"red"}}>{this.state.errorothervacination}</small>:
            ...
            <div style={{display:"flex",justifyContent:"flex-end"}}>
              <Link to={`/customer/induvidual/edit/${this.state.individual_customer_id}`}><Button id='corporatebackbtn' type='reset' value="Cancel" color='warning mr-2'>Back</Button> </Link>
