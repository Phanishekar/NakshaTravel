...
export default class AddEmployee extends Component {
  ...
  let date= moment().format("YYYY-MM-DD")
    if(e.target.name=="individual_dob")
    {
    ...
    axios
      ...
      .then((response) => {
        if (response.data.status == 200) {
          ...
          this.props.history.push(`/customer/corporate/edit/${this.state.corparate_customer_id}`);
        } else {
          this.setState({
  ...
  render() {
    ...
    return (<React.Fragment>
      <BreadCrumbs
        ...
        breadCrumbActive="Add Employee"
      />
      <Card>
        <CardHeader>
          <CardTitle>
            Add {this.state.corparate_name} Employee
          </CardTitle>
        </CardHeader>
        <CardBody>
          ...
          <form onSubmit={this.handleSubmit} id="employee"  >
            <Input
              ...
              value={this.state.corparate_customer_id}
            />
            ...
            <Row>
              ...
              <Col lg="4"  >
                <FormGroup >
                  <Label for="individual_dob">Date of Birth<span style={{color:"red"}}> *</span></Label>
                  <Input type="date"
                    name="individual_dob"
                  ...
                  <small style={{color:"red"}}>{this.state.edf}</small>
                </FormGroup>
              </Col>
              <Col lg="4" >
                <FormGroup >
              ...
              <Col lg="4" >
                <FormGroup>
                  <Label for='individual_citizenship' >Citizenship </Label>
                   <SingleSelect name="individual_citizenship"
                               options={country}
                               getValuesFn={this.getValuesFn}
    ...
    <SingleSelect  name="individual_blood_group" 
            ...
            <Row  >
              ...
              <Col lg="3">
                <FormGroup>
                  <Label htmlFor="sDate">Issue Date</Label>
                  <Input type="date"
...
<small style={{color:"red"}}>{this.state.errorinsurence}</small>
            ...
            <Link to={`/customer/corporate/edit/${this.props.match.params.id}`}><Button id='corporatebackbtn' type='reset' value="Cancel" color='warning mr-2'>Cancel</Button></Link>
