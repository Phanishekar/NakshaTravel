...
async getInvoicesById()
{
  let res=await axios.get(`api/dsr/getById/${this.state.invoice_number}`);
   ...
   {
    let res=await axios.get('api/sales/invoice/SelectBill');
    this.setState({
  ...
  async componentDidMount() {
    ...
    let res=await axios.get(`api/account/selectExpenceAccount`);
    this.setState({
...
if(this.state.setCard==true)
{
    ...
    <Row>
    <Col lg='12'>
      <b>Bill Number:</b> &nbsp;&nbsp;Bill-{this.state.InvoiceDetils.dsr_number}
    </Col>
    </Row>
<br/>
    <Row>
  ...
  invoice = this.state.invoicesList.map(function (invoicesList) {
        ...
        return {label:'Bill'+" - "+invoicesList.dsr_number,value:invoicesList.dsr_number}
 ...
 return (
    <React.Fragment>
        ...
        breadCrumbActive="Edit Payment Made"
      />
        <Card>
            <CardHeader><CardTitle>Edit Payments Made</CardTitle></CardHeader>
            <CardBody>
            ...
            <Row>
                <Col lg="6" >
                  <FormGroup >
                    <Label for="invoice_number">select Bill</Label>
                ...
                <Col lg="4" >
                    ...
                    <Label for="invoice_amount">Bill Amount</Label>
                    <Input 
                      name="invoice_amount"
                      type='text'
            ...
            <Col lg="6" >
                  <FormGroup >
                    <Label for="deposit_account">From the Account</Label>
                      <SingleSelect  
           ...
           <Col lg="2">{this.state.currency}</Col>
             ...
             <Row>
              <Col lg="4">    <Label for='total'>Paying Amount</Label></Col>
             <Col lg="6">
           ...
           <Input name="currency" type='hidden' value={this.state.currency}/>
            ...
            <Link to={'/purchase/paymentMade'}> <Button color="warning mr-2" type="button">Back</Button></Link>
