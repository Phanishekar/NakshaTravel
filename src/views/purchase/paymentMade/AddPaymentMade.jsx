...
<br/>
 ...
 return (
    <React.Fragment>
        ...
        breadCrumbActive="Add Payment Made"
      />
        <Card>
            <CardHeader><CardTitle>Add Payments Made</CardTitle></CardHeader>
            <CardBody>
           ...
           <Input name="currency" type='hidden' value={this.state.currency}/>
            ...
            <Link to={'/purchase/paymentMade'}> <Button color="warning mr-2" type="button">Cancel</Button></Link>
