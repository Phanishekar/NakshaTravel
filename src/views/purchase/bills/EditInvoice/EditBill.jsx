...
this.setState({
  ...
  this.setState({ 
    ...
    if(res.data.passenger)
    {
      ...
      const res2=await axios.get(`api/purchases/supplier/selectSupplier`);
      this.setState({
       
        supplier:res2.data.supplier,
...
getValuesFn = (data) =>
  ...
  async setAddres(id)
  {
      ...
      this.setState({
        email:res.data.supplier.supplier_email,
        phone_number:res.data.supplier.supplier_phone_number,
        country:res.data.supplier.supplier_country, 
        state:res.data.supplier.supplier_state, 
        city:res.data.supplier.supplier_city,
        addres :res.data.supplier.supplier_addres,
        pincode:res.data.supplier.supplier_city_pincode,
      })
 ...
 render(){
  ...
  let  options=[];
options  = this.state.supplier.map(function (corporate) {  
  return {label:corporate.supplier_company_name,value:corporate.supplier_id,cname:corporate.supplier_company_name}
})
...
else
{
 ...
 return (
    ...
    <React.Fragment>
        ...
        breadCrumbActive={stateofProForma+"  Bill"}
      />
          <Card>
    <CardHeader><CardTitle>{stateofProForma} Bill</CardTitle></CardHeader>
    <CardBody>
    <Row>
        <Col lg='12'>
                <b>Bill:</b> Bill-{this.state.DSR.dsr_number}
            </Col>
       ...
       <div style={{display:"flex",justifyContent:"flex-end"}}>
              <Link to="/sales/invoice"><Button type='reset' value="Cancel" color='warning mr-2'>Back</Button></Link>
