...
//   axios
//   .post(`/api/employee/update/${ids}`, formData)
//   .then((response) => {
...
//     const res= await axios.get(`/api/employee/getEmployeeById/${employee_id}`);
...
//         loading:false,
//         employeedetails:res.data.result,
//         name:res.data.result.name,
//         email:res.data.result.email,
//         gender:res.data.result.gender,
//         phone_number:res.data.result.phone_number,
//         emergency_contact_number:res.data.result.emergency_contact_number,
//         dob:res.data.result.dob,
//         joining_date:res.data.result.joining_date,
//         designation:res.data.result.designation,
//         street:res.data.result.street,
//         street2:res.data.result.street2,
...
//         IFSC_code:res.data.result.IFSC_code,
//         bank_branch:res.data.result.bank_branch,
//         gov_id:res.data.result.gov_id,
//         resume:res.data.result.resume,
//         passport:res.data.result.passport,
//         other_documents:res.data.result.other_documents,
//         medical_history:res.data.result.medical_history,
...
// </CardHeader>
// <CardBody>
// <form onSubmit={this.handleSubmit} id="editemployee" >
// <Row>
// <Col lg="4" >
// <FormGroup >
...
// <Input     value={this.state.designation} onChange={this.handleChange} name="designation"
// type='text'
...
// <Input     value={this.state.street}  onChange={this.handleChange} type="textarea" name="street"
...
// <Input     value={this.state.street2} onChange={this.handleChange} type="textarea" name="street2"
// placeholder='Enter Your Complete Adress'>
// </Input>
// </FormGroup>
// </Col>
...
// <Input     value={this.state.bank_name} onChange={this.handleChange}
// type="text"
// name="bank_name"
...
// <Input     value={this.state.IFSC_code} onChange={this.handleChange} name='IFSC_code'
...
// <Input     value={this.state.bank_branch} onChange={this.handleChange} name='bank_branch'
...
// </Input>
// <a href={"https://wellniverse.in/Naksha/api/uploads/" + this.state.resume} target='blank'>{this.state.resume}</a>
// </FormGroup>
// </Col>
// <Col lg="4" >
// <FormGroup>
...
//  >
// </Input>
// <a href={"https://wellniverse.in/Naksha/api/uploads/" + this.state.gov_id} target='blank'>{this.state.gov_id}</a>
// </FormGroup>
// </Col>
// <Col lg="4" >
// <FormGroup>
...
//  >
// </Input>
// <a href={"https://wellniverse.in/Naksha/api/uploads/" + this.state.passport} target='blank'>{this.state.passport}</a>
// </FormGroup>
// </Col>
// <Col lg="4" >
// <FormGroup>
...
//  >
// </Input>
// <a href={"https://wellniverse.in/Naksha/api/uploads/" + this.state.other_documents} target='blank'>{this.state.other_documents}</a>
// </FormGroup>
// </Col>
// </Row>
// <hr />
...
// </Col>
// </Row>
// <div style={{display:"flex",justifyContent:"flex-end"}}><Link to="/employee" >
...
//           breadCrumbActive="Edit employees"
//         />
...
async componentDidMount() {
    ...
    if(res.data.status==200)
    {
      this.setState({    
        ...
        email:res.data.result.email,
        gender:res.data.result.gender,
        blood_group:res.data.result.blood_group,
        phone_number:res.data.result.phone_number,
        emergency_contact_number:res.data.result.emergency_contact_number,
        dob:res.data.result.dob,
        joining_date:res.data.result.joining_date,
        ...
        bank_name:res.data.result.bank_name,
        account_number:res.data.result.account_number,
        account_code:res.data.result.account_code,
        bank_branch:res.data.result.bank_branch,
        swift_code:res.data.result.swift_code,
        gov_id:res.data.result.gov_id,
        resume:res.data.result.resume,
        passport:res.data.result.passport,
        other_document:res.data.result.other_document,
        medical_history:res.data.result.medical_history,
...
if(this.state.loadingDetails){
  ...
  <Card>
  <CardBody>
  <h4 style={{color:"#7367f0",textAlign:"center",fontSize:"20px"}} colsmall="6"><Spinner animation="border" variant="primary" /> Loading.....</h4>
  </CardBody>
</Card>
}else if(this.state.loadingDetails==false){
    Edit_HTML=
...
onChange={this.handleChange} name="account_code"
placeholder='Enter IFSC Code' />
...
<Label for="bank_branch">Bank Branch</Label>
<Input    
type='text' value={this.state.bank_branch} onChange={this.handleChange} name='bank_branch'
placeholder='Enter Branch'
 />
...
<a href={"https://wellniverse.in/Naksha/api/uploads/" + this.state.other_document} target='blank'>{this.state.other_document}</a>
</FormGroup>
</Col>
...
{Object.keys(error).map((key)=>{
  ...
  <Card>
    <CardBody>
    <h4 style={{color:"#7367f0",textAlign:"center",fontSize:"20px"}} colsmall="6"><Spinner animation="border" variant="primary" /> Uploading.....</h4>
    </CardBody>
  </Card>
}
