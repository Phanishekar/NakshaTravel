...
export default class AddQuotation extends Component {
      ...
      if (response.data.status == 200)
       {
        ...
        this.props.history.push(`/addQuotation/${id}/form`);
       } 
      else {
        this.setState(
          {
 ...
 return (
    ...
    <React.Fragment>
        <BreadCrumbs
          ...
          breadCrumbActive= "Add Quotation"
        />
...
<Card>
         ...
         <Input name="type" value="Quotation"
hidden />  
