...
else
{
 ...
 return (
    ...
    <React.Fragment>
        ...
        breadCrumbActive={stateofProForma+"  Invoice"}
      />
          <Card>
    <CardHeader><CardTitle>{stateofProForma} Invoice</CardTitle></CardHeader>
    <CardBody>
    <Row>
        <Col lg='12'>
                <b>Invoice Number:</b> I-{this.state.DSR.dsr_number}
            </Col>
