...
export function DSRlist(props) {
  ...
  const getContry = async (pageNumber) => {
    try {
      ...
      const res = await axios.get(`api/sales/invoice/getAll?page=${pageNumber}`);
...
<Col lg="4" >
<FormGroup>
<Link to="/sales/invoice/add"><Button  color='primary mr-2'>+ Add Invoice</Button> </Link>
</FormGroup>
</Col>
</Row>
