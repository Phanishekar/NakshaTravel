...
handleSubmitVisa(e) {
  ...
  render() {
    ...
    let  options='';
    if(this.props.Ctype=="Corporate")
  {
    options  = this.state.selectPassenger.map(function (passenger) 
    {

      return{
        label:passenger.individual_name,
        value:passenger.individual_name,
        email:passenger.individual_email,
        passport:passenger.individual_passport_number,
        dob:passenger.individual_dob
      }
    ...
    options  = this.state.selectFamily.map(function (passenger)
     {
      ...
      return {
        label:passenger.individual_family_name,
        value:passenger.individual_family_name,
        email:passenger.individual_family_email,
        passport:passenger.individual_family_passport_number,
        dob:passenger.individual_family_dob
      }
