...
else
{
 ...
 return (
    ...
    <React.Fragment>
        ...
        breadCrumbActive={stateofProForma+"  ProForma"}
      />
          <Card>
    <CardHeader><CardTitle>{stateofProForma} ProForma</CardTitle></CardHeader>
    <CardBody>
    <Row>
        <Col lg='12'>
       ...
       <div style={{display:"flex",justifyContent:"flex-end"}}>
              <Link to="/sales/proforma"><Button type='reset' value="Cancel" color='warning mr-2'>Back</Button></Link>
