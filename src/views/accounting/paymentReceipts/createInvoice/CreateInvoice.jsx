...
class CreateInvoice extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <BreadCrumbs
          breadCrumbTitle="Create Payment Receipt"
          breadCrumbParent="Accounting"
          breadCrumbActive="Create Payment Receipt"
        />
        <Card>
          <CardHeader>
              ...
              <Row>
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Due Date">Payment Receipt Date</Label>
                    <Date
                      name="invoice_date"
                ...
                {isUpdateForm ? (
                  <>
                    ...
                    <Col lg="6" md="12">
                      <FormGroup className="my-1">
                        <Label for="Invoice No">Payment Receipt No</Label>
                        <Input
                          name="invoice_no"
...
const mapStateToProps = (state, props) => {
  return {
    invoiceInfo: state.paymentReceipts.invoiceInfo,
