...
const collapseItems = [
  {
    id: 1,
    title: "Summary  (Showing summary for All Payment Receipt)",
  },
  {
    id: 2,
...
class Invoice extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Breadcrumbs
          breadCrumbTitle="Payment Receipt"
          breadCrumbParent="Accounting"
          breadCrumbActive="Payment Receipt"
          link="/paymentReceipts/create"
          label="Create New Payment Receipt"
          color="danger"
        />
        <InvoiceLiFeTimeData />
        <Card>
          <CardHeader>
            <CardTitle>
              Select Filters to see Payment Receipt and Summary
            </CardTitle>
          </CardHeader>
          <CardBody>
            <InvoiceFilter
