...
import { getClientData } from "redux/actions/paymentReceipts";
  ...
  render() {
    return (
      <Row>
        ...
        <Col md={12} sm={12}>
          <h6 className="text-bold-500">Select Payment Receipt Status</h6>
...
const mapStateToProps = (state) => {
  return {
    clientList: state.paymentReceipts.allClientsForFilter,
  };
};
