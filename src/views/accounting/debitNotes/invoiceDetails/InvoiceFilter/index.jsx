...
import { getClientData } from "redux/actions/debitNotes";
  ...
  render() {
    return (
      <Row>
        ...
        <Col md={12} sm={12}>
          <h6 className="text-bold-500">Select Debit Notes Status</h6>
...
const mapStateToProps = (state) => {
  return {
    clientList: state.debitNotes.allClientsForFilter,
  };
};
