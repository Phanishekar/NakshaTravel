...
const collapseItems = [
  {
    id: 1,
    title: "Summary  (Showing summary for All Purchase Orders)",
  },
  {
    id: 2,
...
class Invoice extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Breadcrumbs
          breadCrumbTitle="Purchase Order"
          breadCrumbParent="Accounting"
          breadCrumbActive="Purchase Order"
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              Select Filters to see Purchase Order and Summary
            </CardTitle>
          </CardHeader>
          <CardBody>
            <InvoiceFilter
