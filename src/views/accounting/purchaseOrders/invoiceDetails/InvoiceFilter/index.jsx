...
import { getClientData } from "redux/actions/purchaseOrders";
  ...
  render() {
    return (
      <Row>
        ...
        <Col md={12} sm={12}>
          <h6 className="text-bold-500">Select Purchase Order Status</h6>
...
const mapStateToProps = (state) => {
  return {
    clientList: state.purchaseOrders.allClientsForFilter,
  };
};
