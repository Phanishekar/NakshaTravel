...
class CreateInvoice extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <BreadCrumbs
          breadCrumbTitle="Create Purchase Order"
          breadCrumbParent="Accounting"
          breadCrumbActive="Create Purchase Order"
        />
        <Card>
          <CardHeader>
              ...
              <Row>
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Due Date">Purchase Order Date</Label>
                    <Date
                      name="invoice_date"
                ...
                {isUpdateForm ? (
                  <>
                    ...
                    <Col lg="6" md="12">
                      <FormGroup className="my-1">
                        <Label for="Invoice No">Purchase Order No</Label>
                        <Input
                          name="invoice_no"
                ...
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Billed By">Order By (Yours Details)</Label>
                    <BillBy
                ...
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Billed To">Order To (Clients Details)</Label>
                    <BillTo
...
const mapStateToProps = (state, props) => {
  return {
    invoiceInfo: state.purchaseOrders.invoiceInfo,
