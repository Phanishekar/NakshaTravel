...
const collapseItems = [
  {
    id: 1,
    title: "Summary  (Showing summary for All Delivery Challans)",
  },
  {
    id: 2,
...
class Invoice extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Breadcrumbs
          breadCrumbTitle="Delivery Challan"
          breadCrumbParent="Accounting"
          breadCrumbActive="Delivery Challan"
          link="/deliveryChalan/create"
          label="Create New Delivery Challan"
          color="danger"
        />
        <InvoiceLiFeTimeData />
        <Card>
          <CardHeader>
            <CardTitle>Select Filters to see Delivery Challans and Summary</CardTitle>
          </CardHeader>
          <CardBody>
            <InvoiceFilter
              parsedFilter={queryString.parse(this.props.location.search)}
