...
import {
  ...
  getClientData,
  getBusinessData,
} from "redux/actions/deliveryChalan";
...
class CreateInvoice extends React.Component {
  ...
  getValuesFn = (data) => {
    ...
    } else if (data.id === "invoice_date") {
      formFields["invoice_due"].value = data.value;
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <BreadCrumbs
          breadCrumbTitle="Create Invoice"
          breadCrumbParent="Accounting"
          breadCrumbActive="Create Invoice"
        />
        <Card>
          <CardHeader>
              ...
              <Row>
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Due Date">Delivery Challan Date</Label>
                    <Date
                      id="invoice_date"
                      name="invoice_date"
                ...
                {isUpdateForm ? (
                  <>
                    ...
                    <Col lg="6" md="12">
                      <FormGroup className="my-1">
                        <Label for="Invoice No">Delivery Challan No</Label>
                        <Input
                          name="invoice_no"
                ...
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Billed By">Delivered By (Yours Details)</Label>
                    <BillBy
...
const mapStateToProps = (state, props) => {
  return {
    invoiceInfo: state.deliveryChalan.invoiceInfo,
