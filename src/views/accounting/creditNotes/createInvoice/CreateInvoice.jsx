...
import {
  ...
  getClientData,
  getBusinessData,
} from "redux/actions/creditNotes";
...
class CreateInvoice extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <BreadCrumbs
          breadCrumbTitle="Credit Note"
          breadCrumbParent="Accounting"
          breadCrumbActive="Credit Note"
        />
        <Card>
          <CardHeader>
              ...
              <Row>
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Due Date">Credit Note Date</Label>
                    <Date
                      name="invoice_date"
                ...
                {isUpdateForm ? (
                  <>
                    ...
                    <Col lg="6" md="12">
                      <FormGroup className="my-1">
                        <Label for="Invoice No">Credit Note No.</Label>
                        <Input
                          name="invoice_no"
...
const mapStateToProps = (state, props) => {
  return {
    invoiceInfo: state.creditNotes.invoiceInfo,
