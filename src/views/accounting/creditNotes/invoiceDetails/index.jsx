...
const collapseItems = [
  {
    id: 1,
    title: "Summary  (Showing summary for All Credit Notes)",
  },
  {
    id: 2,
    title: "Credit Notes",
    ...
    return (
      <React.Fragment>
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              Select Filters to see Credit Notes and Summary
            </CardTitle>
          </CardHeader>
          <CardBody>
            <InvoiceFilter
