...
import { getClientData } from "redux/actions/creditNotes";
  ...
  render() {
    return (
      <Row>
        ...
        <Col md={12} sm={12}>
          <h6 className="text-bold-500">Select Credit Note Status</h6>
...
const mapStateToProps = (state) => {
  return {
    clientList: state.creditNotes.allClientsForFilter,
  };
};
