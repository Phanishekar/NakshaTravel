...
import {
  ...
  getClientData,
  getBusinessData,
} from "redux/actions/expenseManagement";
...
class CreateInvoice extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <BreadCrumbs
          breadCrumbTitle="Expense Management"
          breadCrumbParent="Accounting"
          breadCrumbActive="Expense Management"
        />
        <Card>
          <CardHeader>
              ...
              <Row>
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Due Date">Invoice Date</Label>
                    <Date
                      name="invoice_date"
                ...
                {isUpdateForm ? (
                  <>
                    ...
                    <Col lg="6" md="12">
                      <FormGroup className="my-1">
                        <Label for="Invoice No">Expense No</Label>
                        <Input
                          name="invoice_no"
                ...
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Billed By">Billed By (Yours Details)</Label>
                    <BillBy
                ...
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Billed To">Billed To (Clients Details)</Label>
                    <BillTo
