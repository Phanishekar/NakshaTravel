...
import { getClientData } from "redux/actions/expenseManagement";
  ...
  render() {
    return (
      <Row>
        ...
        <Col md={12} sm={12}>
          <h6 className="text-bold-500">Select Expenditure Status</h6>
...
const mapStateToProps = (state) => {
  return {
    clientList: state.expenseManagement.allClientsForFilter,
  };
};
