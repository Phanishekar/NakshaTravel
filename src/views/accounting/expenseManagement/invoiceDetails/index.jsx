...
const collapseItems = [
  {
    id: 1,
    title: "Summary  (Showing summary for All Expenditures)",
  },
  {
    id: 2,
    title: "Expenditures",
    ...
    return (
      <React.Fragment>
        <Breadcrumbs
          ...
          link="/expenseManagement/create"
          label="Create New Expenditure"
          color="danger"
        />
        <InvoiceLiFeTimeData />
        <Card>
          <CardHeader>
            <CardTitle>
              Select Filters to see Expenditures and Summary
            </CardTitle>
          </CardHeader>
          <CardBody>
            <InvoiceFilter
