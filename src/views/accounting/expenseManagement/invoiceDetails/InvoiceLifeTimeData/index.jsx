...
import { getInvoiceDashboardData } from "redux/actions/expenseManagement";
...
const mapStateToProps = (state) => {
  return {
    InvoiceLiFeTimeData: state.expenseManagement,
  };
};
