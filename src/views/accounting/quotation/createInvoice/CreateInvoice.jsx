              ...
              <Row>
                <Col lg="6" md="12">
                  <FormGroup className="my-1">
                    <Label for="Due Date">Quotation Date</Label>
                    <Date
                      id="invoice_date"
                      name="invoice_date"
                ...
                {isUpdateForm ? (
                  <>
                    ...
                    <Col lg="6" md="12">
                      <FormGroup className="my-1">
                        <Label for="Invoice No">Quotation No</Label>
                        <Input
                          name="invoice_no"
...
const mapStateToProps = (state, props) => {
  return {
    invoiceInfo: state.quotation.invoiceInfo,
