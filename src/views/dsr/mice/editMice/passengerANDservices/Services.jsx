...
export default class Services extends Component {
  ...
  async  getdetails(id,fId){

    const res= await axios.get(`/api/mice/hotel/getmice/${id}/${fId}`);
...
return {status:res.data.status,HotelDSR:res.data.result};
  ...
  async  getFlightdetails(id,fId){
    const res2= await axios.get(`/api/mice/flight/getFlight/${id}/${fId}`);
...
return {status:500,Hotel:"error Occured pls try again later"};
  ...
  async  getPackagedetails(id,fId){
    const res2= await axios.get(`/api/mice/package/getpackage/${id}/${fId}`);
    console.log(res2.data); 
//     if(res.data.status==200)
//     {
//     this.setState({
...
return {status:500,Packag:"error Occured pls try again later"};
  ...
  async getVisa(id,fId)
  {
    const res2= await axios.get(`/api/mice/visa/getVisa/${id}/${fId}`);
    console.log(res2.data); 
//     if(res.data.status==200)
//     {
//     this.setState({
...
return {status:500,visa:"error Occured pls try again later"};
  ...
  async getInsurance(id,fId)
  {
    const res2= await axios.get(`/api/mice/insurance/getInsurance/${id}/${fId}`);
    console.log(res2.data); 
//     if(res.data.status==200)
//     {
//     this.setState({
...
return {status:500,Insurance:"error Occured pls try again later"};
  ...
  async getOther(id,fId)
  {
    const res2= await axios.get(`/api/mice/other/getOther/${id}/${fId}`);
    console.log(res2.data); 
//     if(res.data.status==200)
//     {
//     this.setState({
...
if(this.state.loadingtable){
  ...
  hotel=<HotelDSRList id={this.props.id} fId={this.props.fId} currency={this.props.currency} getdetails={this.getdetails}></HotelDSRList>;
  Flight=<FlightDSRList id={this.props.id} fId={this.props.fId} currency={this.props.currency}  getFlightdetails={this.getFlightdetails}></FlightDSRList>;
  Package=<PackageDSR id={this.props.id} fId={this.props.fId} currency={this.props.currency} getPackagedetails={this.getPackagedetails}></PackageDSR>;
  visa=<VisaDSRList id={this.props.id} fId={this.props.fId} currency={this.props.currency}  getVisa={this.getVisa}></VisaDSRList>;
  insurance=<InsuranceDSRList  id={this.props.id} fId={this.props.fId} currency={this.props.currency} getInsurance={this.getInsurance}></InsuranceDSRList>;
  other=<OtherDSRList  id={this.props.id} fId={this.props.fId} currency={this.props.currency} getOther={this.getOther}></OtherDSRList>
}
    var user_HTML_TABLE = "";
    if (this.state.loading == true) {
      ...
      if (this.state.selectedForm == 'Hotel') {
        user_HTML_TABLE = <AddHotel id={this.props.id} fId={this.props.fId} currency={this.props.currency} submit={this.submit}/>
      }
      else if (this.state.selectedForm == 'Flight') {
        user_HTML_TABLE = <AddFlight id={this.props.id} fId={this.props.fId} currency={this.props.currency} submitFlight={this.submitFlight} />
      }
      else if (this.state.selectedForm == 'Visa') {
        user_HTML_TABLE = <Visa id={this.props.id} fId={this.props.fId} currency={this.props.currency} submitVisa={this.submitVisa}/>
      }
      else if (this.state.selectedForm == 'Insurance') {
        user_HTML_TABLE = <Insurance  id={this.props.id} fId={this.props.fId} currency={this.props.currency}  submitInsurance={this.submitInsurance}/>
      }
      else if (this.state.selectedForm == 'Others') {
        user_HTML_TABLE = <Others id={this.props.id} fId={this.props.fId} currency={this.props.currency} submitOthers={this.submitOthers}/>
      }
      else if (this.state.selectedForm == 'Package') {
        user_HTML_TABLE = <ADDPackage id={this.props.id} fId={this.props.fId} currency={this.props.currency} submitPackage={this.submitPackage}/>
      }
    ...
    return (<React.Fragment>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
          <b>Family-{this.props.fId}</b>  Services
          </CardTitle>
        </CardHeader>
        <CardBody>
