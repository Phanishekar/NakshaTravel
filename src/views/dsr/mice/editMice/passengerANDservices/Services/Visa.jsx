...
import {tax,country} from "../../../../../country/CountryList"
...
handleSubmitVisa(e) {
  ...
  render() {
    ...
    options  = this.state.selectPassenger.map(function (passenger) {
        ...
        return {label:passenger.passenger_name,value:passenger.passenger_name,email:passenger.passenger_email,passport:passenger.passport,dob:passenger.passenger_dob}
