  ...
  other=<OtherDSRList  id={this.props.id} currency={this.props.currency} getOther={this.getOther}></OtherDSRList>
    ...
    if (this.state.loading == true) {
      ...
      if (this.state.selectedForm == 'Hotel') {
        user_HTML_TABLE = <AddHotel id={this.props.id} currency={this.props.currency} submit={this.submit}/>
      }
      else if (this.state.selectedForm == 'Flight') {
        user_HTML_TABLE = <AddFlight id={this.props.id} currency={this.props.currency} submitFlight={this.submitFlight} />
      }
      else if (this.state.selectedForm == 'Visa') {
        user_HTML_TABLE = <Visa id={this.props.id} currency={this.props.currency} submitVisa={this.submitVisa}/>
      }
      else if (this.state.selectedForm == 'Insurance') {
        user_HTML_TABLE = <Insurance  id={this.props.id} currency={this.props.currency}  submitInsurance={this.submitInsurance}/>
      }
      else if (this.state.selectedForm == 'Others') {
        user_HTML_TABLE = <Others id={this.props.id} currency={this.props.currency} submitOthers={this.submitOthers}/>
      }
      else if (this.state.selectedForm == 'Package') {
        user_HTML_TABLE = <ADDPackage id={this.props.id} currency={this.props.currency} submitPackage={this.submitPackage}/>
      }
